<template>
  <div class="privacy-wrap">
    ...
    <p class="c3">
      <span class="c2">
        As the controller, the Productpad has implemented numerous technical and
    ...
    <p class="c3">
      <span class="c2">
        The Internet pages of the Productpad use cookies. Cookies are text files
    ...
    <p class="c3">
      <span class="c2">
        Through the use of cookies, the Productpad can provide the users of this
    ...
    <p class="c3">
      <span class="c2">
        ...
        controller&rsquo;s employees are available to the data subject in this
    ...
    <ul class="c6 lst-kix_licn33vegu0m-0">
      ...
      <li class="c0">
        <span class="c2">
          ...
          at any time contact any employee of the Productpad.
        </span>
      </li>
      <li class="c4">
      ...
      <li class="c0">
        <span class="c2">
          ...
          any employee of the Productpad. In addition, the data subject is free
      ...
      <li class="c0">
        <span class="c2">
          ...
          it is based on the data subject&#39;s explicit consent, the Productpad
