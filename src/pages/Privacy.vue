<template>
  <div class="privacy-wrap">
    ...
    <p class="c3">
      <span class="c2">Productpad</span>
    </p>
    <p class="c3">
      <span class="c2">Lohm&uuml;hlenstra&szlig;e 65</span>
    </p>
    <p class="c3">
      <span class="c2">12435 Berlin</span>
    </p>
    <p class="c3">
      <span class="c2">Berlin</span>
    </p>
    <p class="c3">
      <span class="c2">Phone: +4917620659405</span>
    </p>
    <p class="c3">
      <span class="c2">Email: andre.bappert@code.berlin</span>
    </p>
    <p class="c3">
      <span class="c2">Website: www.productcube.io</span>
    </p>
    <h4
      id="h.lmg7o1lk6uut"
      class="c1"
    >
      <span class="c5">3. Cookies</span>
    </h4>
    <p class="c3">
      <span
        class="c2"
    ...
    <p class="c3">
      ...
      >With each call-up to one of the individual pages of this Internet
        ...
        Facebook Plug-ins may be accessed under under under
    ...
    <p class="c3">
      ...
      >German
        Association for Data Protection</a></span><span class="c12">&nbsp;that was developed in cooperation with </span><span class="c10"><a
        class="c8"
        href="https://www.google.com/url?q=https://www.wbs-law.de/eng/practice-areas/internet-law/it-law/&amp;sa=D&amp;ust=1552253817921000"
      >Privacy
        Lawyers</a></span><span class="c2">from WILDE BEUGER SOLMECKE, Cologne.</span>
    </p>
    <p class="c13">
      <span class="c11" />
    </p>
